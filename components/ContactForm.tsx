  ...
  <div className="container my-24 mx-auto md:px-6 ">
    ...
    <section className="mb-32">
      <div className="flex justify-center">
        ...
        <h2 className="text-6xl font-bold mb-12">Get in <span className="text-secondary "> Touch</span> </h2>
        </div>
      </div>
      <div className="flex flex-wrap">
        <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
          <form>
            <div className="relative mb-6 flex flex-col gap-2 px-3" data-te-input-wrapper-init="">
            ...
            <textarea placeholder="Message" className="textarea textarea-primary textarea-lg w-full " ></textarea>
            <button
              type="button"
              data-te-ripple-init=""
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
              <div className="flex items-start">
                <div className="shrink-0">
                  <div className="inline-block rounded-md bg-primary-100 p-4 text-secondary">
                    <svg
